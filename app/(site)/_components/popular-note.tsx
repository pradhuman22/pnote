...
const PopularNoteSection = ({ notes }: { notes: NoteMetadata[] }) => {
  return (
    <section className="relative w-full pt-10">
      <h1 className="mb-5 w-full text-center text-3xl font-semibold lg:text-left">Popular Notes</h1>
            ...
            >
              ...
              >
                ...
                <CardContent className="flex-1">
                  <h3 className="mb-1 line-clamp-1 text-lg font-semibold">{note.title}</h3>
...
export default PopularNoteSection;
