          ...
          <div className="space-y-1.5">
            ...
            <ul className="text-muted-foreground mb-2.5 flex flex-wrap items-center gap-2 text-sm">
              <li className="flex items-center gap-1.5 border-r pr-1.5">
                <ClockIcon className="size-3.5" /> <span>{note.readingTime}</span>
              </li>
              <li className="flex items-center gap-1.5 border-r pr-1.5">
                {' '}
            ...
            <div className="line-clamp-1 text-sm text-purple-500">{note.tags.join(', ')}</div>
          </div>
          <div className="mt-2">
            <p className="text-muted-foreground line-clamp-2 text-base">{note.excerpt}</p>
          </div>
        </div>
      </Card>
    </Link>
